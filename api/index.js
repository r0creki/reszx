...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (action === "discord-callback") {
      ...
      // Kalau ada guild_id = ini dari bot invite, bukan user login
      if (req.query.guild_id) {
        sendToWebhook("success", {
          title: "🤖 Bot Invited to Server",
          fields: {
            "Guild ID": req.query.guild_id,
            "Permissions": req.query.permissions || "Unknown",
            "IP": clientIp
          }
        }).catch(() => {});
